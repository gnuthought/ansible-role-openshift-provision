...
* `remove_unlisted` - Boolean to indicate whether labels or annotations not listed
  should be removed from this project. Optional, default "false". NOTE: setting
  to "true" will delete default OpenShift annotations, use with caution.

* `remove_unlisted_labels` - Same as `remove_unlisted`, but specifically
  targeting labels. Optional, default "false". NOTE: setting to "true"
  will delete default OpenShift labels, use with caution.

* `remove_unlisted_annotations` - Same as `remove_unlisted`, but specifically
  targeting annotations. Optional, default "false". NOTE: setting to "true"
  will delete default OpenShift annotations, use with caution.
